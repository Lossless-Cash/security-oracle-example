...
contract LosslessDevEnvironment is DSTest {
    ...
    address public defiOwner = address(4);
    ...
    /// @notice Sets up Defi Protocol
    function setUpDefiExample() public {
        evm.startPrank(defiOwner);
        defi = new DefiExample(securityOracle);
        evm.stopPrank();
    }
